...
//    @Cacheable(keyGenerator = "byKeyword")
    @Override
    public List<Company> getCompaniesByKey(String key) {
        return companyMapper.getCompaniesByKey(key);
    }

    @Override
    public List<Company> getRequiredCompanies(Company company) {
        return companyMapper.getRequiredCompanies(company);
    }
