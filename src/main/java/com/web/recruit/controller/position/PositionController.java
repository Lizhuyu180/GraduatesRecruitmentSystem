...
public class PositionController extends BaseController {
    ...
    public String searchRequiredPosition(@RequestParam("name") String name,
                                         @RequestParam("sd") Integer sd,
                                         @RequestParam("su") Integer su,
                                         @RequestParam("city") String city,
                                      Map<String, Object> map) {
        Position position=new Position();
        position.setPositionName(name);
        position.setPositionSalaryDown(sd);
        position.setPositionSalaryUp(su);
        position.setPositionCity(city);
        List<Position> positions = positionService.getRequiredPositions(position);
        map.put("positions", positions);
