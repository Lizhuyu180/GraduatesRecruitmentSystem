    ...
    public WebMvcConfigurer webMvcConfigurer() {
        return new WebMvcConfigurer() {
            ...
            public void addViewControllers(ViewControllerRegistry registry) {
                ...
                registry.addViewController("/news.html").setViewName("user/news");
                registry.addViewController("/clist.html").setViewName("user/company_list");
                registry.addViewController("/cdetail.html").setViewName("user/company_detail");
                registry.addViewController("/guide.html").setViewName("user/guide");
                registry.addViewController("/post.html").setViewName("user/post");
                registry.addViewController("/post_detail.html").setViewName("user/post_detail");
