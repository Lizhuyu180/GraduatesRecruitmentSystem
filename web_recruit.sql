...
CREATE TABLE `company`  (
  ...
  `company_description` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `company_address` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `hr`  (
  ...
  `hr_mobile` char(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `position`  (
  ...
  `position_description` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `position_salary_down` int(11) NOT NULL,
  `position_salary_up` int(11) NOT NULL,
  `position_city` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `resume`  (
  ...
  `resume_content` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `resume_work_desire` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `resume_work_experience` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
CREATE TABLE `user`  (
  ...
  `user_account` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `user_graduation` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `user_edu_degree` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
